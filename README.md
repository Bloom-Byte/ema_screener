...
The EMA record update record websocket route is `wss://be.emascreener.bloombyte.dev/ws/ema-records/update/`
`
In production, ensure that you include a valid API key with your connection request. You can do this by

- Adding a url query param `wss://be.emascreener.bloombyte.dev/ws/ema-records/update/?api_key=<your_api_key>`, or
